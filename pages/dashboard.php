            ...
            <div class="content">
                <div class="row card">
                    <h1 class="card-header">Panel de control</h1>
                        ...
                        $resQuery = mysqli_query($con, "SELECT sum(saldo) as saldo_total from cuenta WHERE cliente = '$dni'");
                        ...
                        $resQuery = mysqli_query($con, "SELECT sum(saldo) as saldo_total from cuenta_ahorros WHERE cliente = '$dni'");
                        ...
                        $resQuery = mysqli_query($con, "SELECT sum(saldo) as saldo_total from cuenta_nomina WHERE cliente = '$dni'");
                        ...
                        $resQuery = mysqli_query($con, "SELECT iban, saldo from cuenta WHERE cliente='$cliente'");
                        ...
                        $resQuery = mysqli_query($con, "SELECT iban, saldo from cuenta_nomina WHERE cliente='$cliente'");
                        ...
                        $resQuery = mysqli_query($con, "SELECT iban, saldo from cuenta_ahorros WHERE cliente='$cliente'");
                        ...
                        if(!$resQuery){
                            ...
                            if (!$resQuery) {
                                ...
                                while($row = mysqli_fetch_array($resQuery)){
                                    ...
                                    $resQuery2 = mysqli_query($con, "SELECT fecha, importe, emisor, receptor from transferencia WHERE receptor = '$iban' OR emisor = '$iban' order by fecha DESC");
                                    if (!$resQuery2) {
                                        die ("Error al ejecutar la consulta: " . mysqli_error($con));
                                    }else{
