...
<?php
    ...
    function comprobarNuevoPlanPensiones(){
        $resultado = False;
        
        if(isset($_POST['btnSolicitar'])){
            $ok = comprobarDatosNuevoPlanPensiones();
            
            if($ok){
                $resultado = nuevoPlanPensiones();
    ...
    function comprobarDatosNuevoPlanPensiones(){
        $resultado = False;
...
<body class="bg-color">
    <?php
        $ok = comprobarNuevoPlanPensiones();
